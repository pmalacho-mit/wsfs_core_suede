"""Regenerate the client's view of the backend contract.
    ...
    python3 <path-to-this-package>/frontend/generate.py
...
not about this package, and the last hardcoded one stopped resolving the
moment the layout it named went away. Everything below
...
package sits INSIDE a host package, beside `sqlmodel_utils_suede`.
...
PACKAGE = HERE.parent
"""This package -- the directory holding `backend/` and this."""
HOST = PACKAGE.parent
"""The host package it is vendored into. A package, not just a directory:
`backend/main.py`'s `from ...sqlmodel_utils_suede` resolves here."""
ROOT = HOST.parent
